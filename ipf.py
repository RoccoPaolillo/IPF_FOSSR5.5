...
def process_ipf(origin="original_dataset2023agegen.csv", destination='percent_fitted.csv'):
  # to import csv
  # wd = './'
  # os.chdir(wd)
...
if __name__ == "__main__":
  DEFAULT_ORIGIN = "./data/original_dataset2023agegen.csv"
  DEFAULT_DESTINATION = "./output/percent_fitted.csv"

  parser = argparse.ArgumentParser(description="Process IPF data.")
  parser.add_argument("-o", "--origin", type=str, default=DEFAULT_ORIGIN, help=f"Path to the origin CSV file. default: {DEFAULT_ORIGIN}")
  parser.add_argument("-d", "--destination", type=str, default=DEFAULT_DESTINATION, help=f"Path to the destination CSV file. default: {DEFAULT_DESTINATION}")
  args = parser.parse_args()

  process_ipf(origin=args.origin, destination=args.destination)
